    ...
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-800">
          Welcome back, {user?.fullName || 'Borrower'}
        </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <Link to="/request-loan" className="group bg-white rounded-xl border border-slate-200 p-5 hover:border-sky-300 hover:shadow-md">
        ...
        <Link to="/invoice-discounting" className="group bg-white rounded-xl border border-slate-200 p-5 hover:border-purple-300 hover:shadow-md">
        ...
        <Link to="/my-loans" className="group bg-white rounded-xl border border-slate-200 p-5 hover:border-emerald-300 hover:shadow-md">
          ...
          <p className="text-xs text-slate-500 mt-1">Track status and outstanding amounts</p>
        </Link>
      </div>
